...
Answer: SELECT name FROM people WHERE name = 'Olivia Wright';
...
Answer: DELETE FROM movies WHERE name = 'Batman Begins';
SELECT * FROM movies;
...
Answer: INSERT INTO people (name) VALUES ('Chris Fraser');
SELECT name FROM people;
...
Answer:DELETE FROM people WHERE name = 'James Smith';
SELECT name FROM people;
...
Answer: INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2019, '00:00');
SELECT * FROM movies;
...
Answer: SELECT show_time FROM movies WHERE title = 'Iron Man 2';
19:25
(1 row)
